...
/*!
    ...
    \return void
    \param  errorMessage1: std::string, first error message
    \param  errorMessage2: std::string, second error message
    \param  fixProblem: std::string, a message for fix the error
    \sa     yyerror, execerror
*/
void warning(std::string errorMessage1, std::string errorMessage2, std::string fixProblem = "");
...
/*!
    ...
    \sa     warning, longjmp
*/
void execerror(std::string errorMessage1, std::string errorMessage2, std::string fixProblem = "");
